...
<div class="right_col" role="main" style="min-height: 3823px;">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                <div class="x_title">
                    <h2><?= $page == 'add' ? 'Tambah' : 'Edit' ?> <small>Dosen</small></h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <br>
                    <form method="post" action="<?= base_url('Admin/Guru/process') ?>" enctype="multipart/form-data">
                        <?= form_hidden('id_Guru', $row->id_guru) ?>
                        <?php if ($page == 'add') : ?>
                            <div class="form-group">
                                <label for="nomor_induk">NIP/NIK <span class="required">*</span>
                                </label>
                                <input type="text" id="nomor_induk" class="form-control <?= form_error('nomor_induk') != null ? 'border border-danger' : '' ?>" name="nomor_induk" value="<?= $row->nomor_induk == null ? set_value('nomor_induk') : $row->nomor_induk ?>" placeholder="Enter nomor induk">
                        ...
                        <div class="form_lengkap d-none">
                            <div class="form-group">
                                <label for="nama">Nama Dosen <span class="required">*</span></label>
                                <input type="text" id="nama" class="form-control <?= form_error('nama') != null ? 'border border-danger' : '' ?>" name="nama" value="<?= $row->nama == null ? set_value('nama') : $row->nama ?>" placeholder="Enter nama">
                                <?= form_error('nama') ?>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" id="tempat_lahir" class="form-control <?= form_error('tempat_lahir') != null ? 'border border-danger' : '' ?>" name="tempat_lahir" value="<?= $row->tempat_lahir == null ? set_value('tempat_lahir') : $row->tempat_lahir ?>" placeholder="Enter tempat lahir">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="no_telephone" class="form-control <?= form_error('no_telephone') != null ? 'border border-danger' : '' ?>" name="no_telephone" value="<?= $row->no_telephone == null ? set_value('no_telephone') : $row->no_telephone ?>" placeholder="Enter No. Telephone">
                                <?= form_error('no_telephone') ?>
                            </div>
                            <div class="form-group">
                                <label for="">Apakah Hanya Staf Mentoring Fakultas? (BUKAN DOSEN PA)</label><br>
                                <div class="form-check form-check-inline">
                                    <input name="status_ttq" class="form-check-input" type="checkbox" id="ttq" value="y" <?= @$row->status_ttq == 'y' ? 'checked' : (set_value('status_ttq') == 'y' ? 'checked' : '') ?>>
                                    <label class="form-check-label" for="ttq">Iya, hanya staf kegiatan mentoring fakultas</label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="gambar_upload"><?= $row->gambar != null ? $row->gambar : 'Silahkan masukan Gambar'; ?></label>
                                        <input type="hidden" name="old_gambar" value="<?= $row->gambar; ?>">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <?php $tmp = base_url('vendor/img/guru/') . $row->gambar; ?>
