    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2> <small>Detail Laporan Setoran Hafalan AlQur'an (TTQ)</small></h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <br>
                        ...
                        <?php } ?>
                        <a href="<?= base_url('Admin/LaporanTTQ/index/' . $id_kelas) ?>" class="btn btn-warning btn-sm"><i class="fas fa-backward    "></i> Kembali</a>
                        <div class="row">
