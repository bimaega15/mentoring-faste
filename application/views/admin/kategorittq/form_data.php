        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br>
                        <form method="post" action="<?= base_url('Admin/KategoriTtq/process') ?>">
                            <?= form_hidden('id_KategoriTtq', $row->id_kategori_ttq) ?>
                            <div class="row">
                                <div class="col-md-8 mx-auto">
                                    <div class="form-group row">
                                        <label for="nama" class="col-sm-2 col-form-label">Nama <span class="required">*</span></label>
                                        <div class="col-sm-10">
                                            <input name="nama" class="form-control datepicker <?= form_error('nama') != null ? 'border border-danger' : '' ?>" type="text" id="nama" placeholder="Enter your nama Kategori Ttq" value="<?= $row->nama == null ? set_value('nama') : $row->nama; ?>">
                                            <?= form_error('nama') ?>
                                        </div>
                                    </div>
