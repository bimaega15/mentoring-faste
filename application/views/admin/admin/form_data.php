...
<div class="right_col" role="main" style="min-height: 3823px;">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                <div class="x_title">
                    <h2><?= $page == 'add' ? 'Tambah' : 'Edit' ?> <small>Admin</small></h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <br>
                    <form method="post" action="<?= base_url('Admin/Admin/process') ?>" enctype="multipart/form-data">
                        <?= form_hidden('id_Admin', $row->id_admin) ?>
                        <?php if ($page == 'add') : ?>
                            <div class="form-group">
                                <label for="nomor_induk">ID Admin<span class="required">*</span>
                                </label>
                                <input type="text" id="nomor_induk" class="form-control <?= form_error('nomor_induk') != null ? 'border border-danger' : '' ?>" name="nomor_induk" value="<?= $row->nomor_induk == null ? set_value('nomor_induk') : $row->nomor_induk ?>" placeholder="Enter ID Admin">
                        ...
                        <div class="form_lengkap d-none">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <?php $tmp = base_url('vendor/img/admin/') . $row->gambar; ?>
