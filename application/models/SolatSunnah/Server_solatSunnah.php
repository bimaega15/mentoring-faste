<?php
class Server_solatSunnah extends CI_Model
{
    var $table = 'solat_sunah'; //nama tabel dari database
    var $column_order = array(
        null, 'tanggal', 'waktu', 'nama', 'keterangan'
    ); //field yang ada di table user
    var $column_search = array('tanggal', 'waktu', 'nama', 'keterangan'); //field yang diizin untuk pencarian 
    var $order = array('id_solat_sunah' => 'desc'); // default order 
    var $users = '';
    var $siswa = '';
    var $kategori = '';
